...
//	ArgTs&&... args)
constexpr inline std::ostream& osprintout(
	std::ostream& os, concepts::HasStdOstmOpLshift auto&&... args
) {
...
constexpr inline std::ostream& osprint_hexdump(
	std::ostream& os,
	...
	auto show_text = [&os, &line_break, &text, &i]() -> void {
		osprintout(os, "  ||  ");
...
constexpr inline std::ostream& osprint_arr(
	std::ostream& os, ArrT* to_print, size_t size
) {
...
constexpr inline std::ostream& osprint_arr(
	std::ostream& os, const std::array<ElemT, size>& to_print
) {
